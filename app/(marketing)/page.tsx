...
export default async function Home() {
  return (
    <div className="container px-4 md:px-8">
      <article className="prose-stone prose">
        <PageHeader
          title="How Much Water Should You Drink Daily? Discover with Our Water Intake Calculator"
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              <strong>Climate</strong>: Hot and humid climates can cause
              increased sweating and fluid loss, requiring higher water intake.
            </li>

            <li>
              <strong>Health conditions</strong>: Certain health conditions,
              such as kidney stones or urinary tract infections, may require
              increased water intake.
            </li>

            <li>
              <strong>Pregnancy and breastfeeding</strong>: Pregnant and
              breastfeeding women need additional water to support the growth
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              <strong>Headaches</strong>: Lack of water can trigger headaches
              and migraines.
            </li>
            <li>
        ...
        <p>
          ...
          <ol>
            <li>
              <strong>Carry a water bottle</strong>: Keep a reusable water
              bottle with you at all times to remind yourself to drink water
              regularly.
            </li>
            <li>
              <strong>Set reminders</strong>: Use a hydration app or set
              reminders on your phone to drink water at regular intervals.
            </li>
            <li>
              <strong>Infuse your water</strong>: Add slices of fruits or herbs
              to your water to enhance the flavor and make it more enjoyable to
              drink.
            </li>
            <li>
              <strong>Eat water-rich foods</strong>: Include fruits and
              vegetables with high water content, such as watermelon, cucumbers,
            ...
            <li>
              ...
              Hydrate before, during, and after physical activity to replenish
              the fluids lost through sweat.
            </li>
            <li>
              <strong>Monitor urine color</strong>: Check the color of your
              urine. If it is pale yellow or clear, it indicates that you are
              well-hydrated.
            </li>
          </ol>
        </p>
