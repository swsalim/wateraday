  ...
  'inline-flex items-center justify-center rounded-md duration-200 ease-in-out',
  {
    variants: {
      variant: {
        ...
        ghost:
          'bg-transparent text-zinc-700 hover:bg-zinc-100 hover:text-zinc-700 border-transparent border-solid border-[1px] focus:border-amber-300 active:bg-amber-100 active:text-amber-700',
        danger:
